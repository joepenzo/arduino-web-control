...
<!--    <script src="js/jquery.cookie.js"></script>-->
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(){
            if ( (localStorage.getItem("iptext") != "") && (localStorage.getItem("porttext") != "") && (localStorage.getItem("passwordtext") != "") ){
                // storage filled
                $.mobile.changePage('#dialog_settings_succes', 'pop', true, true);
            }
            $('#iptext').val(localStorage.getItem("iptext"));
            $('#porttext').val(localStorage.getItem("porttext"));
            $('#passwordtext').val(localStorage.getItem("passwordtext"));

            console.log('iptext  ' + localStorage.getItem("iptext") + ' && porttext ' + localStorage.getItem("porttext") + ' && passwordtext ' + localStorage.getItem("passwordtext") );
...
<div data-role="dialog" id="dialog_settings_error">
    ...
    <script type="text/javascript">
        ...
        $("#setting_button").click( function() {
            localStorage.setItem("iptext", $('#iptext').val());
            localStorage.setItem("porttext", $('#porttext').val());
            localStorage.setItem("passwordtext", $('#passwordtext').val());
            if ( (localStorage.getItem("iptext") != "") && (localStorage.getItem("porttext") != "") && (localStorage.getItem("passwordtext") != "") ){
                // storage filled
                $.mobile.changePage('#dialog_settings_succes', 'pop', true, true);
            } else if ( (localStorage.getItem("iptext") == "") && (localStorage.getItem("porttext") == "") && (localStorage.getItem("passwordtext") == "") ) {
        ...
        $("#rgb_button").click( function() {
            ...
            var green;
            var blue;
            $.get("arduinorgbrequest.php", { r: $('#slider-red').val(), g: $('#slider-green').val(), b: $('#slider-blue').val() }, function(data){
                red = data.red;
                green = data.green;
                blue = data.blue;
                console.log('red ' + red + ' && green ' + green + ' && blue ' + blue);
